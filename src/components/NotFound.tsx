...
export default function NotFound() {
  ...
  return (
    ...
    <div className="mt-20 items-center justify-center flex flex-col gap-2 ">
      ...
      />
      <h1 className="font-prompt text-2xl dark:text-white">
        A página requisitada não foi encontrada.
      </h1>
      <button className="py-4 px-8 font-bold rounded-lg bg-lightblue dark:bg-main text-white text-xl hover:bg-darkblue dark:hover:bg-darkblue" >
